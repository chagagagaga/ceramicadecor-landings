...
window.LP = {
 ...
 "catalog": [
  ...
  },
  {
   ...
   "collection": "Камея",
   "desc": "Портал для банной печи в облицовке «Камея». Изразец ручной формовки, обжиг свыше 1100 °C.",
   "spec": {
    "weight": 96
   },
   "p1": 613386,
  ...
  },
  {
   ...
   "collection": "Арт Нуво",
   "desc": "Портал для банной печи в облицовке «Арт Нуво». Изразец ручной формовки, обжиг свыше 1100 °C.",
   "spec": {
    "weight": 45,
    "width": 1280,
    "height": 930,
 ...
 "why": {
  ...
  "bad": [
   "Голый металл даёт жёсткое инфракрасное тепло: рядом с печью сидеть некомфортно.",
 ...
 "faq": [
  ...
  },
  {
   ...
   "a": "Да, обжиг свыше 1100 °C — рабочий режим парной для изразца безопасен. Важнее правильный монтаж с температурным зазором: керамика и металл расширяются по-разному, зазор закладываем на этапе замера."
  },
  {
  ...
  {
   "q": "Сколько ждать?",
   "a": "От заявки до сдачи — 3–4 месяца. Основная часть срока — ручное изготовление керамики, монтаж занимает 2–4 дня. Роспись по индивидуальному сюжету добавляет 1–2 недели: эскиз сначала согласовываем с вами."
  },
  {
   "q": "Что с гарантией?",
