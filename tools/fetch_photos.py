...
def to_webp(raw, dst, width=1600, quality=82):
    """Пережимает оригинал в webp, сохраняя пропорции кадра.

    1600 px по ширине, а не 1100, как было раньше. Лайтбокс показывает кадр
    во всю высоту экрана: на ноутбуке это ~1330 физических пикселей, и
    картинка в 1100 заметно мылила. Иван: «качество фотки шакальное,
    не хватает пикселей, а люди такой продукт глазами оценивают».
    Оригиналы на сайте бывают до 6000 px, запас есть почти везде.
    """
