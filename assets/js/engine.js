...
(function () {
  ...
  (function metrika() {
    ...
    // На локальном сервере счётчик не поднимаем: каждый прогон тестов
    // иначе ложится в статистику как визит, а цели — как конверсии.
  ...
  var Calc = (function () {
    ...
    function syncChan() {
      ...
      $('[data-mtitle]', modal).textContent = call ? 'Перезвоним с расчётом' : channel ? 'Пришлём расчёт в мессенджер' : 'Получить расчёт';
