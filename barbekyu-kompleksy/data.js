...
window.LP = {
 ...
 "why": {
  ...
  "bad": [
   "Штукатурка чувствительна к перепадам температур: холодная зима и жар мангала приводят к трещинам в облицовке за пару сезонов.",
   "Кирпич сложен в уходе — копоть и жир создают неопрятный вид, а вы устанете от уборки.",
   "Кирпичные и оштукатуренные комплексы визуально нейтральны: может и неплохо, но среди соседей выделиться не получится.",
   "Осадки и жгучее солнце снимают гарантии на внешний вид вашей летней кухни."
  ],
  "good": [
   "Обжиг при 1000 °C делает керамику практически неуязвимой к открытому огню и невзгодам погоды.",
   "Глянцевая поверхность глазури легко очищается от любых видов загрязнений.",
   "Множество коллекций и цветовых решений позволяют создать уникальный проект под характер вашего дома.",
   "Гарантия 50 лет на керамику — зафиксирована в договоре."
  ],
  "media": "img/09-3.webp"
 },
 "steps": [
