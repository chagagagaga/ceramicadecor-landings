...
window.LP = {
 ...
 "catalog": [
  ...
  },
  {
   ...
   "collection": "Дорф",
   "desc": "Типовая модель в облицовке «Дорф», цвет горький шоколад. Комплект со склада, монтаж под ключ.",
   "p1": 439000,
   "p2": 0,
   "img": "img/02.webp",
   "photos": [
  ...
  },
  {
   ...
   "collection": "Дорф",
   "desc": "Комплект каминной облицовки Дорф в цвете Муравленый. Изразцы с характерной зеленоватой «муравленой» глазурью — традиционной для русского изразцового…",
   "p1": 439000,
   "p2": 0,
   "img": "img/03.webp",
   "photos": [
   ...
   "surface": "",
   "kind": "",
   "full": "Комплект каминной облицовки Дорф в цвете Муравленый. Изразцы с характерной зеленоватой «муравленой» глазурью — традиционной для русского изразцового искусства. Каждый элемент выполнен вручную."
  },
  {
   "title": "Печь-камин Ритм, Белый Антик",
   "collection": "Ритм",
   "desc": "Типовая модель в облицовке «Ритм», цвет белый антик. Комплект со склада, монтаж под ключ.",
   "p1": 449000,
   "p2": 0,
   "img": "img/04.webp",
   "photos": [
  ...
  },
  {
   ...
   "collection": "Ритм",
   "desc": "Типовая модель в облицовке «Ритм», цвет бургундия. Комплект со склада, монтаж под ключ.",
   "p1": 449000,
   "p2": 0,
   "img": "img/05.webp",
   "photos": [
  ...
  },
  {
   ...
   "collection": "Ритм",
   "desc": "Типовая модель в облицовке «Ритм», цвет лазурный. Комплект со склада, монтаж под ключ.",
   "p1": 449000,
   "p2": 0,
   "img": "img/06.webp",
   "photos": [
