...
"barbekyu-kompleksy": dict(
    ...
    sub="Соберите конфигурацию за минуту — пришлём смету, 3D-эскиз и фотографии похожих сданных объектов. Звоним только если попросите.",
...
"bannye-portaly": dict(
    ...
    badge="Москва и МО · выезд замерщика бесплатно",
    sub="Соберите портал за минуту — пришлём смету, 3D-эскиз и фотографии похожих сданных объектов. Звоним только если попросите.",
...
"russkie-pechi": dict(
    ...
    badge="Москва и МО · 3D-проект бесплатно",
    sub="Соберите печь за минуту — пришлём смету, 3D-эскиз и фотографии похожих сданных объектов. Звоним только если попросите.",
    usp=["Смета и 3D-эскиз за 2 дня", "Замер по Москве и МО — 0 ₽", "Цена в договоре не растёт", "Гарантия 50 лет на керамику"],
  ...
  <div class="container hero__inner">
    <div>
      ...
      <div class="hero__cta">
        ...
        <span>Минута — и смета у вас в мессенджере</span>
      </div>
