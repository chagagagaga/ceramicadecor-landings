...
BRAND = {
    ...
    # ⚠️ ССЫЛКА НЕ РАБОТАЕТ — max.ru/ceramicadecor не отвечает вообще.
    # Это заглушка, поставленная при сборке: настоящий адрес канала так
    # и не пришёл. Человек жал «Написать в MAX» и попадал в никуда —
    # хуже, чем отсутствие кнопки: он уже решил написать, а мы его теряли.
    # Пустая строка прячет кнопку во всех трёх местах (шапка, док, панель).
    # Чтобы вернуть: вставить сюда адрес из приложения MAX
    # (профиль → «Поделиться» → «Скопировать ссылку») и пересобрать.
    "maxUrl": "",
...
"barbekyu-kompleksy": dict(
    ...
    usp=["Смета и 3D-эскиз за 2 дня", "3D-проект бесплатно", "Цена в договоре не растёт", "Гарантия 50 лет на керамику"],
    ...
    why=dict(
        ...
        bad=["Штукатурка чувствительна к перепадам температур: холодная зима и жар мангала приводят к трещинам в облицовке за пару сезонов.",
        ...
        good=["Обжиг при 1000 °C делает керамику практически неуязвимой к открытому огню и невзгодам погоды.",
...
"pechi-kaminy": dict(
    ...
    why=dict(
        ...
        bad=["Проектирование и согласование обычно занимают 2–3 недели ещё до начала работ.",
             ...
             "Изготовление занимает 4–8 недель: если начинать осенью, к холодам можно не успеть.",
...
"bannye-portaly": dict(
    ...
    usp=["Смета и 3D-эскиз за 2 дня", "3D-проект бесплатно", "Под любую банную печь", "Гарантия 50 лет на керамику"],
  ...
  <div class="container hero__inner">
    <div>
      ...
      <div class="hero__cta">
        ...
        <span>Расчёт пришлём в мессенджер. Без звонков и регистраций</span>
      </div>
