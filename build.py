...
def spec_tiles(sp, p1, p2, photos):
    ...
    Раньше недостающие плитки добивались дельтой монтажа и числом
    кадров — заказчик снял и то и другое: дельта дублирует две цены
    ниже и путает, а количество фотографий ничего не говорит об
    изделии. Осталось только физическое: вес и габариты.
