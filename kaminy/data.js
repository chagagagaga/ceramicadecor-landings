 ...
 "catalog": [
  {
   "title": "Камин Альбион",
   "collection": "Альбион",
   "desc": "Классический белый камин Альбион с топкой LISEO CASTIRON. Изразцовая облицовка ручной работы в белоснежной цветовой гамме создаёт элегантный и…",
   "spec": {
    "weight": 218,
    "width": 1325,
    "height": 2535,
  ...
  },
  {
   "title": "Камин Тюльпан",
   "collection": "Тюльпан",
   "desc": "Камин в облицовке Тюльпан с Г-образной топкой Экокамин Альфа 1000 RB. Рельефные изразцы с цветочным орнаментом в зелёных тонах.",
   "spec": {
    "weight": 243,
    "width": 1377,
    "height": 2499,
   ...
   "surface": "",
   "kind": "",
   "full": "Камин в облицовке Тюльпан с Г-образной топкой Экокамин Альфа 1000 RB. Рельефные изразцы с цветочным орнаментом в зелёных тонах. Г-образная топка позволяет наслаждаться видом огня с двух сторон."
  },
  {
   "title": "Камин Тюльпан, Арктика",
   "collection": "Тюльпан",
   "desc": "Комплект каминной облицовки Тюльпан в цвете Арктика. Белоснежные изразцы с рельефными тюльпанами создают нежный и воздушный образ камина.",
   "p1": 793469,
   "p2": 1150000,
   "img": "img/04.webp",
   "photos": [
   ...
   "surface": "",
   "kind": "",
   "full": "Комплект каминной облицовки Тюльпан в цвете Арктика. Белоснежные изразцы с рельефными тюльпанами создают нежный и воздушный образ камина. Идеально подходит для светлых интерьеров."
  },
  {
   "title": "Камин Версаль",
   "collection": "Версаль",
   "desc": "Изразцовый камин Версаль в цвете Арктическая лагуна. Облицовка с детализированным орнаментом в насыщенных лазурных тонах.",
   "p1": 1001758,
   "p2": 2084728,
   "img": "img/05.webp",
   "photos": [
   ...
   "surface": "",
   "kind": "",
   "full": "Изразцовый камин Версаль в цвете Арктическая лагуна. Облицовка с детализированным орнаментом в насыщенных лазурных тонах. Вдохновлен интерьерами французских дворцов. Каждый изразец изготовлен вручную."
  },
  {
   "title": "Камин Бристоль",
   "collection": "Бристоль",
   "desc": "Камин с П-образной топкой в облицовке «Бристоль» в цвете Чёрная ночь. Тёмные изразцы с глубокой глазурью создают драматичный и стильный образ.",
   "spec": {
    "weight": 236,
    "width": 1260,
    "height": 2745,
   ...
   "surface": "",
   "kind": "",
   "full": "Камин с П-образной топкой в облицовке «Бристоль» в цвете Чёрная ночь. Тёмные изразцы с глубокой глазурью создают драматичный и стильный образ. П-образная топка обеспечивает обзор огня с трёх сторон."
  },
  {
   "title": "Камин Дорф",
   "collection": "Дорф",
   "desc": "Декоративный камин с очагом Airtone Andalle 1000, облицован изразцами коллекции Дорф. Специально разработанный проект для ресторанного интерьера.",
   "spec": {
    "weight": 432,
    "width": 1680,
    "height": 3691,
   ...
   "surface": "",
   "kind": "",
   "full": "Декоративный камин с очагом Airtone Andalle 1000, облицован изразцами коллекции Дорф. Специально разработанный проект для ресторанного интерьера. Масштабная облицовка от пола до потолка создаёт величественный акцент."
  },
  {
   "title": "Камин Арт Нуво",
   "collection": "Арт Нуво",
   "desc": "Комплект каминной облицовки Арт Нуво в фисташковой декоративной палитре. Изящные линии модерна в сочетании с нежными зелёными тонами.",
   "p1": 612738,
   "p2": 1433372,
   "img": "img/09.webp",
   "photos": [
   ...
   "surface": "",
   "kind": "",
   "full": "Комплект каминной облицовки Арт Нуво в фисташковой декоративной палитре. Изящные линии модерна в сочетании с нежными зелёными тонами. Вдохновлён стилем ар-нуво начала XX века."
  },
  {
   "title": "Камин Птицы",
   "collection": "Птицы",
   "desc": "Изразцовый камин с топкой Астов П2С в облицовке Птицы. Ручная роспись с изображением птиц в природном окружении.",
   "p1": 1464041,
   "p2": 2552550,
   "img": "img/10.webp",
   "photos": [
   ...
   "surface": "",
   "kind": "",
   "full": "Изразцовый камин с топкой Астов П2С в облицовке Птицы. Ручная роспись с изображением птиц в природном окружении. Каждый изразец — это маленькое произведение искусства."
  },
  {
   "title": "Камин Византия",
   "collection": "Византия",
   "desc": "Изразцовый камин Византия в росписи Олива. Богатый орнамент, вдохновлённый византийским искусством, выполнен в тёплых оливковых тонах.",
   "p1": 1426640,
   "p2": 2241366,
   "img": "img/11.webp",
   "photos": [
   ...
   "surface": "",
   "kind": "",
   "full": "Изразцовый камин Византия в росписи Олива. Богатый орнамент, вдохновлённый византийским искусством, выполнен в тёплых оливковых тонах. Сложная многослойная роспись с золотистыми акцентами."
  },
  {
   "title": "Камин Луна",
   "collection": "Луна",
   "desc": "Камин в классическом стиле из коллекции Луна с топкой Spartherm Linear 4S Arte. Элегантные изразцы с лунным орнаментом в сочетании с немецкой топкой.",
   "spec": {
    "weight": 194,
    "width": 1122,
    "height": 2657,
   ...
   "surface": "",
   "kind": "",
   "full": "Камин в классическом стиле из коллекции Луна с топкой Spartherm Linear 4S Arte. Элегантные изразцы с лунным орнаментом в сочетании с немецкой топкой. Утончённый дизайн для изысканных интерьеров."
  },
  {
  ...
  },
  {
   ...
   "collection": "Универсал",
   "desc": "Облицовка углового камина изразцами Универсал. Топка с двумя стёклами обеспечивает широкий обзор огня.",
   "spec": {
    "weight": 108,
    "width": 1348,
    "height": 2022,
   ...
   "surface": "",
   "kind": "",
   "full": "Облицовка углового камина изразцами Универсал. Топка с двумя стёклами обеспечивает широкий обзор огня. Минималистичные изразцы подчеркнуты глазурью благородного зелёного цвета с разнотоном."
  },
  {
  ...
  },
  {
   "title": "Камин Браво",
   "collection": "Браво",
   "desc": "Камин в облицовке изразцами коллекции Браво с росписью. Яркий и выразительный дизайн с авторской росписью.",
   "spec": {
    "weight": 165,
    "width": 1310,
    "height": 1510,
   ...
   "surface": "",
   "kind": "",
   "full": "Камин в облицовке изразцами коллекции Браво с росписью. Яркий и выразительный дизайн с авторской росписью. Каждый камин этой коллекции уникален благодаря ручной работе мастеров."
  },
  {
   "title": "Камин Сохо",
   "collection": "Сохо",
   ...
   "surface": "",
   "kind": "",
   "full": "Облицовка камина до полки с дровниками по бокам в коллекции Сохо. Современный и функциональный дизайн: облицовка доходит до каминной полки, а по бокам расположены дровники. Стильное решение для современных интерьеров."
  },
  {
   "title": "Камин Усадьба",
   "collection": "Усадьба",
   "desc": "Изразцовый камин Усадьба с призматической угловой топкой. Рельефные изразцы ручной формовки в традиционном стиле русской усадьбы.",
   "spec": {
    "weight": 172,
    "width": 1390,
    "height": 2370,
   ...
   "surface": "",
   "kind": "",
   "full": "Изразцовый камин Усадьба с призматической угловой топкой. Рельефные изразцы ручной формовки в традиционном стиле русской усадьбы. Призматическая топка и практичные полки создают объемную архитектурную композицию камина."
  },
  {
   "title": "Камин Птички",
   "collection": "Птички",
   "desc": "Каминная облицовка Птички в декоративной палитре Лесная. Изразцы с миниатюрными птичками среди растительного орнамента в зелёных лесных тонах.",
   "p1": 808246,
   "p2": 1450000,
   "img": "img/19.webp",
   "photos": [
   ...
   "surface": "",
   "kind": "",
   "full": "Каминная облицовка Птички в декоративной палитре Лесная. Изразцы с миниатюрными птичками среди растительного орнамента в зелёных лесных тонах. Создаёт атмосферу природной гармонии."
  },
  {
   "title": "Камин Элеганс",
   "collection": "Элеганс",
   "desc": "Комплект каминной облицовки Элеганс в цвете Лесной Туман. Изысканные изразцы с мягкими приглушёнными тонами, напоминающими утренний туман в лесу.",
   "p1": 949823,
   "p2": 1945720,
   "img": "img/20.webp",
   "photos": [
   ...
   "surface": "",
   "kind": "",
   "full": "Комплект каминной облицовки Элеганс в цвете Лесной Туман. Изысканные изразцы с мягкими приглушёнными тонами, напоминающими утренний туман в лесу. Идеальный выбор для создания спокойной и расслабляющей атмосферы."
  },
  {
   "title": "Камин Минималист",
   "collection": "Минималист",
   "desc": "Каминная облицовка в стиле минимализм. Чистые линии и лаконичные формы без лишнего декора.",
   "p1": 907913,
   "p2": 1367144,
   "img": "img/21.webp",
   "photos": [
   ...
   "surface": "",
   "kind": "",
   "full": "Каминная облицовка в стиле минимализм. Чистые линии и лаконичные формы без лишнего декора. Идеальный выбор для современных интерьеров, где ценится сдержанность и функциональность."
  },
  {
   "title": "Камин Венская",
   "collection": "Венская",
   "desc": "Электрокамин белого цвета в изразцах коллекции Венская. Элегантная облицовка в венском стиле для электрокамина.",
   "p1": 810963,
   "p2": 1380000,
   "img": "img/22.webp",
   "photos": [
   ...
   "surface": "",
   "kind": "",
   "full": "Электрокамин белого цвета в изразцах коллекции Венская. Элегантная облицовка в венском стиле для электрокамина. Белоснежные изразцы с утончённым рельефом создают образ без необходимости дымохода."
  },
  {
