...
window.LP = {
    ...
    "options": [
     {
      "id": "stove",
      "label": "Печь-камин",
      "hint": "Самый бюджетный вариант: готовая модель со склада, 439 000 ₽",
      "fixed": 439000,
 ...
 "catalog": [
  ...
  },
  {
   ...
   "kind": "",
   "props": [],
   "id": "kamin-albion-majolikovaya-glazur"
  },
  {
   "title": "Камин Тюльпан",
   "collection": "Тюльпан",
  ...
  },
  {
   ...
   "kind": "",
   "props": [],
   "id": "kamin-venskaya-klassicheskij"
  }
 ],
 "filters": [
  {
 ...
 "faq": [
  {
   ...
   "a": "Облицовка начинается от 200 000 ₽, комплект под ключ с топкой и монтажом — от 900 000 ₽. Разброс большой, потому что художественная роспись почти вдвое дороже однотонной глазури. Посчитайте свою конфигурацию в калькуляторе выше."
  },
  {
